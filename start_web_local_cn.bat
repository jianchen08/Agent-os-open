...
:: ===========================================================================
:: 5. 启动后端（端口 8988，内存模式降级，无需 Redis）
:: ===========================================================================
echo [INFO] 启动后端（端口 8988，不依赖 Redis，自动内存模式）...
start "Agent OS Backend (local)" /D "%cd%" cmd /k "set PYTHONPATH=src&& "%PYEXE%" -m channels.websocket.app_factory"

:: ===========================================================================
:: 6. 启动前端（vite dev server，端口 5289，proxy 到 8988）
:: ===========================================================================
echo [INFO] 启动前端（vite dev server，端口 5289）...
