...
from _log_context import LogContext
...
def setup_logging(
    ...
    """初始化日志系统（转发到本目录 _log_context.py shim，模拟 0.1 src.core.logging 接口）。
    ...
    """
    from _log_context import LoggingConfig, setup_logging as _unified_setup  # noqa: PLC0415
