...
# 允许的搜索类型（消息搜索依赖已废弃的 YAML 执行记录，已移除）
_SEARCH_TYPES = ("all", "session")
...
@router.get("", summary="统一搜索会话")
def search(
    q: str = Query(default="", description="搜索关键词"),
    type: str = Query(default="all", description="搜索类型：all/session"),
