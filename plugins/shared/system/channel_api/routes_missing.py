...
async def get_monitoring_tasks(
    ...
    """
    from memory_store import store  # noqa: F401,PLC0415
...
async def list_eval_metrics_alias(
    ...
    try:
        from routes_evaluation import _get_metric_loader, _metric_to_response  # noqa: PLC0415
...
async def get_eval_metric_alias(metric_id: str, _user: dict = Depends(require_auth)) -> dict[str, Any]:
    try:
        from routes_evaluation import _get_metric_loader, _metric_to_detail  # noqa: PLC0415
