...
class ToolInstallation:
    ...
    tool_id: str
    user_id: str
    status: str  # installed, uninstalled, failed
...
# 全局工具市场实例
_tool_marketplace = None


def get_tool_marketplace() -> ToolMarketplace:
    """获取工具市场实例"""
    global _tool_marketplace
    if _tool_marketplace is None:
        _tool_marketplace = ToolMarketplace()
    return _tool_marketplace
