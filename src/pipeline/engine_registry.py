...
class EngineRegistry:
    ...
    def register_pipeline(
        ...
        *,
        ...
        logger.info("[EngineRegistry] register_pipeline: pid=%s tid=%s tags=%s", engine.pipeline_id[:12], thread_id[:12] if thread_id else "", tags)
    ...
    def ensure_bridge(
        ...
        *,
        ...
        logger.debug(
            ...
            pipeline_id[:12], bridge is not None,
