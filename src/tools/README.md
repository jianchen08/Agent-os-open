...
| 文件 | 行数 | 职责 |
|------|------|------|
| `tools/__init__.py` | ~10 | 模块导出（ToolRegistry, ToolDefinition） |
| `tools/types.py` | ~25 | ToolDefinition dataclass |
| `tools/registry.py` | ~100 | ToolRegistry 简化版注册表 |
| `tools/README.md` | 本文件 | 模块文档 |
| `plugins/core/tool_core.py` | ~180 | ToolCore 工具执行 Core 插件 |
| `plugins/output/pending_tools.py` | ~87 | PendingToolsOutput 输出插件 |
| `tests/test_tool_core.py` | ~343 | 单元测试（23 个） |
