...
SKIP_DIRS = {
    ...
    # tool / AI caches
    ".zcode", ".zcode_e2e", ".ai_workspaces", ".dbg", ".dbg",
    # runtime artifacts
...
SKIP_EXT = {
    "pyc", "pyo", "d", "rmeta", "rlib", "pdb", "exe", "dll", "so",
    "o", "obj", "a", "lib", "map", "wasm", "class", "jar",
    "png", "jpg", "jpeg", "gif", "ico", "bmp", "svg",
    "zip", "tar", "gz", "7z", "rar", "pdf", "ttf", "woff", "woff2", "eot",
    "db", "db-shm", "db-wal", "sqlite", "bin", "dat",
...
LANG = {
    ...
    "sh": "Shell", "bash": "Shell", "bat": "Batch", "ps1": "PowerShell",
    "yaml": "YAML", "yml": "YAML", "toml": "TOML",
    "json": "JSON", "md": "Markdown", "txt": "Text", "rst": "reStructuredText",
    "sql": "SQL", "proto": "Proto", "graphql": "GraphQL",
    "lua": "Lua", "r": "R", "ipynb": "Jupyter",
}

CATEGORY = {
    "Python": "Source", "Rust": "Source", "TypeScript": "Source",
    "TSX (React)": "Source", "JavaScript": "Source", "JSX": "Source",
    "CSS": "Source", "SCSS": "Source", "Less": "Source",
    "HTML": "Source", "Vue": "Source", "Go": "Source", "Java": "Source",
    "C++": "Source", "C": "Source", "C/C++ Header": "Source", "C++ Header": "Source",
    "SQL": "Source", "Proto": "Proto/IDL", "GraphQL": "Proto/IDL",
    "PowerShell": "Scripts", "Shell": "Scripts", "Batch": "Scripts",
    "YAML": "Config", "TOML": "Config", "JSON": "Config/Data",
    "Markdown": "Docs", "Text": "Docs", "reStructuredText": "Docs",
    "Lua": "Source", "R": "Source", "Jupyter": "Docs",
}

stats = collections.defaultdict(lambda: [0, 0])  # lang -> [files, lines]
total_files = 0
total_lines = 0
...
for lang in sorted(stats, key=lambda k: -stats[k][1]):
    f, l = stats[lang]
    out.append(f"{lang:<18}{f:>8}{l:>12}")

out.append("\n=== By Category ===")
cat = collections.defaultdict(lambda: [0, 0])
for lang, (f, l) in stats.items():
