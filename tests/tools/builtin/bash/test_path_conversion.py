...
class TestConvertWindowsPathsForWsl:
    ...
    def test_drive_backslash(self):
        """反斜杠盘符路径应正确转换。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl(r"cat D:\data\file.txt")
            == "cat /mnt/d/data/file.txt"
        )

    def test_drive_forward_slash(self):
        """正斜杠盘符路径应正确转换。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl("cat D:/data/file.txt")
            == "cat /mnt/d/data/file.txt"
        )
    ...
    def test_drive_uppercase(self):
        """大写盘符应转小写。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl(r"ls C:\Users")
            == "ls /mnt/c/Users"
        )
    ...
    def test_long_path_prefix(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl(
                r"cat \\?\D:\very\long\path\file.txt"
            )
    ...
    def test_wsl_unc_path(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl(
                r"cat \\wsl$\Ubuntu\home\user\file.txt"
            )
    ...
    def test_wsl_localhost_unc_path(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl(
                r"cat \\wsl.localhost\Ubuntu\home\user\file.txt"
            )
            == "cat /home/user/file.txt"
        )
    ...
    def test_quoted_path_with_spaces(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl(
                r'cat "D:\path with space\file.txt"'
            )
    ...
    def test_quoted_path_with_parentheses(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl(
                r'cat "D:\Program Files (x86)\app.exe"'
            )
    ...
    def test_mixed_with_unix_path(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl(
                r"cp D:\src\a.txt /home/user/b.txt"
            )
    ...
    def test_relative_path_not_converted(self):
        """相对路径不应被转换。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl("cat ./file.txt")
            == "cat ./file.txt"
        )
    ...
    def test_unix_path_not_converted(self):
        """已经是 Unix 风格的路径不应被转换。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl("cat /mnt/d/file.txt")
            == "cat /mnt/d/file.txt"
        )
    ...
    def test_network_share_not_converted(self):
        """网络共享路径不应被转换。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl(r"ls \\server\share")
            == r"ls \\server\share"
        )
    ...
    def test_env_variable_not_converted(self):
        """环境变量路径不应被转换。"""
        assert (
            ProcessManager._convert_windows_paths_for_wsl("cat $HOME/file.txt")
            == "cat $HOME/file.txt"
        )
    ...
    def test_no_windows_path(self):
        ...
        assert (
            ProcessManager._convert_windows_paths_for_wsl("ls -la /home/user")
            == "ls -la /home/user"
        )
