 ...
 *
 * schema 是全站核心数据源（agents/pipelines/tools/contributes），此前三处独立
 * 调 getSchema 无共享缓存（SettingsPage/SettingsHubWidget/GrowthLoop 各自裸拉）。
 * 本 query 收敛为单一缓存：进入设置页秒开、staleTime 窗口内跨页零请求。
