...
/**
 * KnowledgeBaseContent 覆盖缺口补充测试（与 actionFeedback 测试互补）：
...
describe('KnowledgeBaseContent 拖拽上传', () => {
...
describe('KnowledgeBaseContent 删除条目', () => {
...
describe('KnowledgeBaseContent 分类管理', () => {
...
describe('KnowledgeBaseContent 数据呈现', () => {
