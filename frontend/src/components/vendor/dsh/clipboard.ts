 ...
 * Copyright (c) 2026 DeepSeek. Source: packages/client/ui-primitives/src/clipboard.ts
 * Repo pinned at commit 47f943859bef60e4160492346772ded9b24f765a (version 0.1.0-rc.5). Adapted for AgentOS
 * (task_dsh_plugin_adapter 任务 3): verbatim copy, import paths adjusted (./clipboard.ts).
 */
